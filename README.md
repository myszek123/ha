...
- **Fixed wall rate**: plan and charge at **`fast_amps` (11 A)**. Cheapest hours filled first; leftover dearer minutes sit at the **tail** of the earlier hour so the block is continuous (e.g. 12:44–15:00, not 12:00–14:16)
